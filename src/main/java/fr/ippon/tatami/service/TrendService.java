...
import static fr.ippon.tatami.web.rest.util.AnalysisUtil.findMostUsedKeys;
import static fr.ippon.tatami.web.rest.util.AnalysisUtil.incrementKeyCounterInMap;
...
public class TrendService {
    ...
    public List<TrendDTO> getCurrentTrends(String domain) {
    ...
    public List<TrendDTO> getTrendsForUser(String email) {
        List<String> tags = userTrendRepository.getRecentTags(email);
        return calculateTrends(tags);
    }

    private List<TrendDTO> calculateTrends(List<String> tags) {
