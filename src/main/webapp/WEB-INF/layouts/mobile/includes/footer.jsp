...
<footer id="center-footer">
	...
	<script type="text/javascript" src="/assets/js/bootstrap/2.0.4/bootstrap.min.js"></script>
	<script type="text/javascript" src="/assets/js/less/less-1.3.0.min.js"></script>
</footer>
