                  ...
                  <div class="alert alert-status">
                    <div class="row-fluid">
                      <div class="span4 text-center avatar-float-left-container">
                        <a class="pull-left" href="/tatami/profile/${user.username}/" title="<fmt:message key="tatami.user.profile.show"/> @${user.username} ${user.firstName} ${user.lastName}">
                          <img class="nomargin avatar avatar-float-left" src="https://www.gravatar.com/avatar/${user.gravatar}?s=64&d=mm" alt="${user.firstName} ${user.lastName}">
                        </a>
