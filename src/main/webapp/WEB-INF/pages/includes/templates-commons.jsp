    ...
    <div class="row-fluid">
      <table class="statuses">
          ...
          <tr>
              <td>
                  <@ if (status.replyTo != '') { @>
                  <div><a href="/tatami/profile/<@= status.replyToUsername @>/#/status/<@= status.replyTo @>" class="userStatus-info"><i class="icon-pencil"></i> <fmt:message key="tatami.user.status.replyto"/> <em>@<@= status.replyToUsername @></em></a></div>
                  <@ } @>
              </td>
          </tr>
          <tr>
