...
ERLANG_INSTALL_LIB_DIR_thrift = ${ERLANG_INSTALL_LIB_DIR}/thrift-0.9.2
...
PYTHON_VERSION = 2.7
PY_PREFIX = /usr
QT_CFLAGS = -DQT_SHARED -I/usr/include/qt4 -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtNetwork  
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /thrift/lib/nodejs
abs_srcdir = /thrift/lib/nodejs
